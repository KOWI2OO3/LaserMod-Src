...
public class ContainerInfuser extends Container {
	...
	public ContainerInfuser(int windowId, PlayerInventory playerInv, PacketBuffer data) {
		this(windowId, playerInv, getTileEntity(playerInv, data));
	}
	
	public ContainerInfuser(int windowId, PlayerInventory playerInv, TileEntityInfuser te) {
	...
	private static TileEntityInfuser getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
