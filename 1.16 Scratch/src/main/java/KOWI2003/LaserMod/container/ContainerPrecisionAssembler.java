...
public class ContainerPrecisionAssembler extends Container {

	private TileEntityPrecisionAssembler te;
	
	public ContainerPrecisionAssembler(int windowId, PlayerInventory playerInv, PacketBuffer data) {
		this(windowId, playerInv, getTileEntity(playerInv, data));
	}
	
	public ContainerPrecisionAssembler(int windowId, PlayerInventory playerInv, TileEntityPrecisionAssembler te) {
	...
	private static TileEntityPrecisionAssembler getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
