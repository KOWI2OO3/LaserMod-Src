...
public class GuiPrecisionAssembler extends ContainerScreen<ContainerPrecisionAssembler> {
	...
	public GuiPrecisionAssembler(ContainerPrecisionAssembler container, PlayerInventory playerInv, ITextComponent titleIn) {
	...
	public GuiPrecisionAssembler(PlayerInventory playerInv, TileEntityPrecisionAssembler te) {
		super(new ContainerPrecisionAssembler(3, playerInv, te), playerInv, te.getDisplayName());
		this.te = te;
		this.player = playerInv.player;
		this.playerInv = playerInv;
	}
