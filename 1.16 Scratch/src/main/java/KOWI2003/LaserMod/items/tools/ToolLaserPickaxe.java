...
public class ToolLaserPickaxe extends ItemLaserToolBase {
	...
	public ToolLaserPickaxe(Properties properties, float speed, float damageBaseline,
		...
		super(properties.addToolType(net.minecraftforge.common.ToolType.PICKAXE, miningLevel), DIGGABLES, speed, damageBaseline, maxCharge);
	...
	public float getDestroySpeed(ItemStack stack, BlockState state) {
		if(isExtended(stack)) {
			Material material = state.getMaterial();
			return material != Material.METAL && material != Material.HEAVY_METAL && material != Material.STONE ? super.getDestroySpeed(stack, state) : getProperties(stack).getProperty(KOWI2003.LaserMod.LaserProperties.Properties.SPEED);
		}
