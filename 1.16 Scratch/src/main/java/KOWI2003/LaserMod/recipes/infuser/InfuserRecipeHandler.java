...
public class InfuserRecipeHandler {
	...
	static Map<String, IInfuserRecipe> recipes = new HashMap<String, IInfuserRecipe>();
	
	public static void register() {
		registerRecipe("laser_crystal", new ItemStack(ModItems.LaserCrystal), new ItemStack(Items.REDSTONE, 4), new ItemStack(Items.DIAMOND));
		registerRecipe("tool_charger", new InfuserRecipeChargingTool());
		registerRecipe("silicon", new ItemStack(ModItems.Silicon), new ItemStack(Items.IRON_NUGGET), ItemTags.SAND);
	}
	...
	public static List<IInfuserRecipe> getAllRecipes() {
		List<IInfuserRecipe> list = new ArrayList<IInfuserRecipe>();
	...
	public static <T extends IInfuserRecipe> List<IInfuserRecipe> getRecipes(Class<? extends T> ... exluding) {
		List<Class<? extends T>> exRecipe = new ArrayList<Class<? extends T>>();
