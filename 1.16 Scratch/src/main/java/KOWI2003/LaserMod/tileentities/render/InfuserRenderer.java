...
public class InfuserRenderer extends TileEntityRenderer<TileEntityInfuser> {

	public InfuserRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@Override
	public void render(TileEntityInfuser te, float partialTicks, MatrixStack matrix,
		...
		if(!te.handler.getStackInSlot(2).isEmpty()) {
			float scale = 0.2f;
			if(te.handler.getStackInSlot(2).getItem() == ModItems.LaserCrystal) {
