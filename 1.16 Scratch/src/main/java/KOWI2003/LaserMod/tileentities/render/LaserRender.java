...
public class LaserRender extends TileEntityRenderer<TileEntityLaser> {
	
	private float uMin, vMin = 0;
	
	public LaserRender(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}
	
	@Override
	public boolean shouldRenderOffScreen(TileEntityLaser te) {
		return te.active && (te.getDirection() == Direction.NORTH || te.getDirection() == Direction.WEST || te.distance > 10);
	}
	
	@Override
	public void render(TileEntityLaser te, float partialTicks, MatrixStack matrix,
