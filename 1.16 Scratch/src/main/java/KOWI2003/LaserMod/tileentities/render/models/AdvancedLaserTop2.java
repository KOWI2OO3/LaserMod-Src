...
public class AdvancedLaserTop2 extends EntityModel<Entity> {

    //fields
    public final ModelRenderer Rotatingbase;
    public final ModelRenderer Piston1base;
    public final ModelRenderer Piston1baseattach;
    public final ModelRenderer Piston1;
    public final ModelRenderer Piston1attach;
    public final ModelRenderer Piston2attach;
    public final ModelRenderer Piston2baseattach;
    public final ModelRenderer Piston2base;
    public final ModelRenderer Piston2;
    public final ModelRenderer Piston3attach;
    public final ModelRenderer Piston3;
    public final ModelRenderer Piston3base;
    public final ModelRenderer Piston3baseattach;
    public final ModelRenderer Piston4baseattach;
    public final ModelRenderer Piston4attach;
    public final ModelRenderer Piston4base;
    public final ModelRenderer Piston4;
    public final ModelRenderer Rotatingbase2;
    public final ModelRenderer Laserhead;

    public AdvancedLaserTop2()
    {
        ...
        Rotatingbase.texOffs(64, 64).addBox(-2F, 0F, -2F, 4F, 0.5F, 4F, false);

        Piston1base = new ModelRenderer(this, 24, 13);
        Piston1base.setPos(-8F, 22.15F, -6.3F);
        Piston1base.texOffs(64, 64).addBox(2F, -0.2499998F, -1.8F, 0.5F, 0.5F, 1.65F, false);
        setRotationAngle(Piston1base, -5.890486F, 0F, 0F);
        
        Piston1baseattach = new ModelRenderer(this, 8, 0);
        Piston1baseattach.setPos(-6F, 22.35F, -6.6F);
        Piston1baseattach.texOffs(64, 64).addBox(0F, -0.5000001F, 0F, 0.6f, 0.6f, 0.6f, false);
        setRotationAngle(Piston1baseattach, 0F, 0F, 0F);
        
        Piston1 = new ModelRenderer(this, 16, 12);
        Piston1.texOffs(64, 64).setPos(-8F, 22.15F, -6.3F);
        setRotationAngle(Piston1, -5.890486F, 0F, 0F);
        
        Piston1attach = new ModelRenderer(this, 12, 4);
        Piston1attach.setPos(-8F, 23.35F, -8F);
        Piston1attach.texOffs(64, 64).addBox(2F, 0F, -2F, 0.5f, 0.5f, 0.5f, false);
        setRotationAngle(Piston1attach, 0F, 0F, 0F);
        
        Piston2attach = new ModelRenderer(this, 12, 4);
        Piston2attach.setPos(-8F, 23.35F, -8F);
        Piston2attach.texOffs(64, 64).addBox(-2F, 0F, -2.5F, 0.5f, 0.5f, 0.5f, false);
        setRotationAngle(Piston2attach, 0F, 0F, 0F);
        
        Piston2baseattach = new ModelRenderer(this, 8, 0);
        Piston2baseattach.setPos(-6.6F, 22.35F, -10.6F);
        Piston2baseattach.texOffs(64, 64).addBox(0F, -0.5000001F, 0F, 0.6f, 0.6f, 0.6f, false);
        setRotationAngle(Piston2baseattach, 0F, 0F, 0F);
        
        Piston2base = new ModelRenderer(this, 16, 10);
        Piston2base.setPos(-6.3F, 22.15F, -10.3F);
        Piston2base.texOffs(64, 64).addBox(-1.8F, -0.2499998F, -0.1999998F, 1.65f, 0.5f, 0.5f, false);
        setRotationAngle(Piston2base, 0F, 0F, 5.890486F);
        
        Piston2 = new ModelRenderer(this, 0, 0);
        Piston2.setPos(-6.3F, 22.15F, -10.3F);
//        Piston2.addBox(-3.65F, -0.2F, -0.1500001F, 2.3f, 0.4f, 0.4f, false);
        Piston2.texOffs(64, 64);
        setRotationAngle(Piston2, 0F, 0F, 5.890486F);
        
        Piston3attach = new ModelRenderer(this, 12, 4);
        Piston3attach.setPos(-8F, 23.35F, -8F);
        Piston3attach.texOffs(64, 64).addBox(1.5F, 0F, 2F, 0.5f, 0.5f, 0.5f, false);
        setRotationAngle(Piston3attach, 0F, 0F, 0F);
...
//        Piston3.addBox(1.45F, -0.2F, -0.25F, 2.3f, 0.4f, 0.4f);
        ...
        setRotationAngle(Piston3, 0F, 0F, 0.3926991F);
        
        Piston3base = new ModelRenderer(this, 16, 10);
        Piston3base.setPos(-9.7F, 22.15F, -5.7F);
        Piston3base.texOffs(64, 64).addBox(0.1999998F, -0.2499998F, -0.3000002F, 1.65f, 0.5f, 0.5f, false);
        setRotationAngle(Piston3base, 0F, 0F, 0.3926991F);
        
        Piston3baseattach = new ModelRenderer(this, 8, 0);
        Piston3baseattach.setPos(-10F, 22.35F, -6F);
        Piston3baseattach.texOffs(64, 64).addBox(0F, -0.5000001F, 0F, 0.6f, 0.6f, 0.6f, false);
        setRotationAngle(Piston3baseattach, 0F, 0F, 0F);
        
        Piston4baseattach = new ModelRenderer(this, 8, 0);
        Piston4baseattach.setPos(-10.6F, 22.35F, -10F);
        Piston4baseattach.texOffs(64, 64).addBox(0F, -0.5000001F, 0F, 0.6f, 0.6f, 0.6f, false);
        setRotationAngle(Piston4baseattach, 0F, 0F, 0F);
        
        Piston4attach = new ModelRenderer(this, 12, 4);
        Piston4attach.setPos(-8F, 23.35F, -8F);
        Piston4attach.texOffs(64, 64).addBox(-2.5F, 0F, 1.5F, 0.5f, 0.5f, 0.5f, false);
        setRotationAngle(Piston4attach, 0F, 0F, 0F);
        
        Piston4base = new ModelRenderer(this, 24, 13);
        Piston4base.setPos(-10.3F, 22.15F, -9.7F);
        Piston4base.texOffs(64, 64).addBox(-0.1999998F, -0.2499998F, 0.09999943F, 0.5f, 0.5f, 1.65f, false);
        setRotationAngle(Piston4base, -0.3926991F, 0F, 0F);
        
        Piston4 = new ModelRenderer(this, 16, 12);
        Piston4.setPos(-10.3F, 22.15F, -9.7F);
//        Piston4.addBox(-0.1500003F, -0.2F, 1.49F, 0.4f, 0.4f, 2.3f, false);
        Piston4.texOffs(64, 64);
        setRotationAngle(Piston4, -0.3926991F, 0F, 0F);
        
        Rotatingbase2 = new ModelRenderer(this, 0, 6);
        Rotatingbase2.setPos(-8F, 23.35F, -8F);
        Rotatingbase2.texOffs(64, 64).addBox(-1.75F, 0.5F, -1.75F, 3.5f, 0.3f, 3.5f, false);
        setRotationAngle(Rotatingbase2, 0F, 0F, 0F);
        
        Laserhead = new ModelRenderer(this, 0, 2);
        Laserhead.setPos(-8F, 23.35F, -8F);
        Laserhead.texOffs(64, 64).addBox(-1.5F, 0.7F, -1.5F, 3, 0.25f, 3, false);
        setRotationAngle(Laserhead, 0F, 0F, 0F);
    }
