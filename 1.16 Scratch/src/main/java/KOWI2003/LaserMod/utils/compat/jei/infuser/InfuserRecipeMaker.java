...
public class InfuserRecipeMaker {
	...
	public static List<IInfuserRecipe> getRecipes(IJeiHelpers helper) {
		...
		recipes.add(contructToolRecipe(ModItems.LaserSword));
		recipes.add(contructToolRecipe(ModItems.LaserPickaxe));
		recipes.add(contructToolRecipe(ModItems.LaserAxe));
